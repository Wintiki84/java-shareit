...
public class ItemController {
    ...
    public ResponseEntity<ItemDto> save(@RequestHeader("X-Sharer-User-Id") @Min(0) long userId,
                        @Validated(Create.class) @RequestBody @Min(0) ItemDto itemDto) {
    ...
    public ResponseEntity<ItemDto> update(@PathVariable @Min(0) long itemId,
    ...
    @JsonView(Details.class)
    @GetMapping("/{itemId}")
    public ResponseEntity<ItemDto> getItemById(@PathVariable @Min(0) long itemId,
                               @RequestHeader("X-Sharer-User-Id") @Min(0) long userId) {
    ...
    @JsonView(Details.class)
    @GetMapping
    public ResponseEntity<List<ItemDto>> getAllUserItems(@RequestHeader("X-Sharer-User-Id") @Min(0) long userId) {
    ...
    @JsonView(Details.class)
    @GetMapping("/search")
    public ResponseEntity<List<ItemDto>> search(@RequestHeader("X-Sharer-User-Id") @Min(0) long userId,
