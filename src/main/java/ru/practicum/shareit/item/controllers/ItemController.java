...
public class ItemController {
    ...
    public ResponseEntity<ItemDto> save(@RequestHeader("X-Sharer-User-Id") @Positive long userId,
    ...
    @JsonView(Details.class)
    @GetMapping
    public ResponseEntity<List<ItemDto>> getAllUserItems(@RequestHeader("X-Sharer-User-Id") @Positive long userId) {
    ...
    @JsonView(Details.class)
    @GetMapping("/search")
    public ResponseEntity<List<ItemDto>> search(@RequestHeader("X-Sharer-User-Id") @Positive long userId,
